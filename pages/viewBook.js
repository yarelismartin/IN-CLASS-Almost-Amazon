...
const viewBook = (obj) => {
  ...
  <div class="mt-5 d-flex flex-wrap">
   <div class="d-flex flex-column">
     ...
     <div class="mt-5">
       <i id="edit-book-btn--${obj.firebaseKey}" class="btn btn-info"><span id="edit-book-btn--${obj.firebaseKey}" class="fas fa-edit"></span></i>
       <i id="delete-book--${obj.firebaseKey}" class="btn btn-danger"><span id="delete-book-btn--${obj.firebaseKey}" class="fas fa-trash-alt"></i>
     </div>
   </div>
